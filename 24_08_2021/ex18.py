...
class Contrato(Bancos):
    ...
    def __init__(self, cod_banco: str = None, val_despesa: str = '1100,1', desc_despesa: str = None) -> None:
...
class App(tk.Frame):
    ...
    def _criar_widgets(self) -> None:
        ...
        self.frame_results = ttk.Labelframe(self.master,text='Resultado')
        self.frame_results.place(relwidth=1, relheight=0.5, rely=0.5)
